  ...
  subroutine disturbance_rates( site_in, bc_in)
    ...
    do while (associated(currentPatch))   
       ...
       do while(associated(currentCohort))        
          ...
          currentCohort%dmort  = cmort+hmort+bmort+frmort+smort+asmort+ddmort
       ...
       if (currentPatch%disturbance_rates(dtype_ilog) > currentPatch%disturbance_rates(dtype_ifall) .and. &
          ...
          do while(associated(currentCohort))
             if(currentCohort%canopy_layer == 1)then
                ...
                currentCohort%ddmort = currentCohort%ddmort*(1.0_r8 - fates_mortality_disturbance_fraction)
             end if
             currentCohort => currentCohort%taller
          enddo !currentCohort
                 ...
                 if(currentPatch%disturbance_mode .eq. dtype_ifall) then
                     ...
                     if(currentCohort%canopy_layer == 1)then
                      ...
                      if(EDPftvarcon_inst%woody(currentCohort%pft) == 1)then
                         ...
                         nc%ddmort           = currentCohort%ddmort
